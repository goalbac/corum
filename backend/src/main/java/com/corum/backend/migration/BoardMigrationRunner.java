...
public class BoardMigrationRunner implements CommandLineRunner {
    ...
    private static final List<BoardMigrationSpec> SPECS = List.of(
            ...
            new BoardMigrationSpec("Jaral", "JaralC", 71L), // 세상자 제도 > 자랄 말씀
            new BoardMigrationSpec("Gijido", "GijidoC", 72L), // 세상자 제도 > 기지도
            ...
            new BoardMigrationSpec("JwaJedoJido", "JwaJedoJidoC", 78L), // 모든 세상자 > 좌제도 지도
