  ...
  <div class="admin-dashboard">
    ...
    <div class="quick-links">
      ...
      <div class="ql-grid">
        ...
        <router-link to="/admin/boards" class="ql-item">
        ...
        <router-link to="/admin/inquiries" class="ql-item">
...
onMounted(async () => {
  try {
    ...
    // 대시보드 보조 지표이므로 개별 API 실패 시 화면 진입은 유지한다.
  }
})
</script>
...
.stat-value { font-size: 22px; font-weight: 700; color: var(--t1); }
